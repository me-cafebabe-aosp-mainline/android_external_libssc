...
#define SSC_MSG_REPORT_MEASUREMENT_LIGHT		1025
#define SSC_MSG_REPORT_MEASUREMENT_ACCELEROMETER	1025
#define SSC_MSG_REPORT_MEASUREMENT_MAGNETOMETER		1025
#define SSC_MSG_REPORT_MEASUREMENT_ROTATIONVECTOR	1025
